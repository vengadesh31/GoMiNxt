...
.container.active .card.alt .title, .container.active .card.alt .input-container,
...
.card.alt .input-container input:focus ~ .bar:before, .card.alt .input-container input:focus 
	~ .bar:after {
	background: #ffffff;
}
...
/* Keyframes */
@
-webkit-keyframes buttonFadeInUp { 0% {
	bottom: 30px;
	opacity: 0;
}
...
<div class="card"></div>
			<div class="card">
				...
				<form:form modelAttribute="userModel" action="adduserdetail" method="post">
					...
					<div class="input-container">
						<form:input type="email" id="email" path="emailId" /> 
						<form:errors path="emailId" cssStyle="color:red"></form:errors>
						<label
							for="Email">EmailId</label>
						<div class="bar"></div>
					</div>
					<div class="input-container">
					...
					<div class="input-container">
						<form:input type="Mobile" id="Mobile" path="mobileNo" />
